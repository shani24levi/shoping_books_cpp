...
BEBS::SalesControl::~SalesControl()
		...
		void BEBS::SalesControl::InitializeComponent(void)
		{
			...
			series5->Font = (gcnew System::Drawing::Font(L"Arial", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			series5->LabelForeColor = System::Drawing::Color::MidnightBlue;
